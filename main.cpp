...
static const char *_defaultDataPath = "/usr/local/home/hode/";

#ifdef RG350
static const char *_defaultSavePath = "/usr/local/home/hode/";
#else
...
int main(int argc, char *argv[]) {
	...
	g_system->init(_title,RG350_W,RG350_H, _fullscreen, _widescreen, isPsx);
	setupAudio(g);
